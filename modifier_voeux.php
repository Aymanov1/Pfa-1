    ...
    <tr>
	  ...
	  require_once("connexion.php");
		require_once("connexion.php");
                      ...
                      $id_Voeux=  $_SESSION['id'];
                     $matiere= $_SESSION['matiere'];
                      $type=$_SESSION['type'];
                         $groupe=$_SESSION['groupe'];
                       $section=$_SESSION['section'];
                       $datashow= $_SESSION['datashow'];
                        $jumlage=$_SESSION['jumlage'];
                     $journéeCon=  $_SESSION['journéeCon'];
                       $maxh= $_SESSION['maxh'];
                        $maxjps= $_SESSION['maxjps'];
                           $salle=$_SESSION['salle'];
                            $crenaux= $_SESSION['crenaux'];
		...
		$query = "select distinct niveau_mat from matiere";
      ...
      <td width="41">
	  <div id="matiere1">
	  <select style="max-width:50px;" name="matiere" value="<?php echo $matiere;?>" id="matiere">
